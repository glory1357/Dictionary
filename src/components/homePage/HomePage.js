...
const HomePage = () => {
    ...
    const results = word.word && !fetchingError && !wordLoadingStatus ? <div className="word__search">
        <div className="word__search-success">Нашли слово: <span>{word.word}</span>! Посетить страницу?</div>
        <Link to={`/${word.word}`} className='button button__secondary'>
